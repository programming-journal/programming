...
% Set the creator tool, so that arXiv doesn't complain
\AtBeginDocument{\hypersetup{pdfcreator={programming},pdfproducer={programming}}}
...
% Note: If the abstract is longer than 300 words, it might spill on the second
% page. In this case, please add \smaller after \begin{abstract}
\begin{abstract}
